...
- **支払い済みチェック**: 支払い後、購入者本人(入力者)が注文カードの「支払い済み」にチェック。確認者と日時を記録し、名前別合計に支払い状況(済/未/一部)と未収額を表示
...
| 項目 | 選択肢 |
|---|---|
| 胸ロゴ | 有(ロゴ小 白) / 有(ロゴ小 カラー1) / 有(ロゴ小 カラー2) / 有(ロゴ小 黒) / 有(ロゴ大 白) / 有(ロゴ大 カラー1) / 有(ロゴ大 カラー2) / 有(ロゴ大 カラー3) / 有(ロゴ大 黒) / 無 |
| バックプリント | 有(白) / 有(黒) / 無 |
| サイズ | S / M / L / XL / 2XL / 3XL / 4XL / 5XL / 持ち込み |
| カラー | 1.BK 〜 20.MT の20色(色ごとに数量を入力。持ち込みサイズは色なしで数量のみ) |

選択肢を変更したい場合は `shared/constants.js` を編集してください。

胸ロゴ(無以外)とバックプリント有には、管理者が**サンプル画像**を設定できます
(「価格を設定」内からアップロード。注文フォームの選択肢の横に小さく表示されます)。
