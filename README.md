...
- **Tシャツ代**: サイズ別価格+持ち込み価格
- **スクリーン版代**(複数登録可、各版は「ロゴ用/ロゴ大用/バックプリント用」を選択)
  - ロゴ用: 白 = 版代÷(白合計+カラー合計)×白合計 / カラー = 同×カラー合計 / ロゴ無 = 0
  - ロゴ大用: 白・大/カラー・大の発注数合計で同様に分配(通常ロゴとは別勘定)
  - バックプリント用: 有 = 版代÷有の発注数合計(1枚あたり) / 無 = 0
- **スクリーン工賃**: 通常ロゴ・大ロゴ×バックプリント有無の9種類
  (白ロゴ+BP / カラーロゴ+BP / 白ロゴ大+BP / カラーロゴ大+BP / ロゴ無+BP /
   白ロゴ+BP無 / カラーロゴ+BP無 / 白ロゴ大+BP無 / カラーロゴ大+BP無)
