...
- 第4章は手紙や文字を使わない。娘を母へ向いた三分の二正面にし、伏せた視線、わずかに開いた唇、
  内側へ寄せた肩、腰元で落ち着かず絡める両手、一歩を踏み出せない重心によって、
  「心では謝っているのに声にできない」を表す。第5章は離れる手、第7章は支える手へ視線をつなぐ。
...
- 第4章からは手紙と紙の音を除き、沈黙と小さな心拍だけで言い出せない間を支える。
  第6章から和音と空間を広げる。
...
## Scene 4 cinematic refinement

- `image-stylize` の人物同一性維持、禁止要素、複数候補比較の設計を使用。
- Gemini版はAPIキーを認識したが、画像モデルの無料枠が0のためHTTP 429となった。
  そのため同一プロンプト仕様を組み込み画像編集へ適用し、2候補を生成して比較した。
- 候補1を採用。母親肩越しの構図、人物、服装、伏せた視線、言いかけた唇、
  制服の裾をつまむ両手を維持し、雨の寒色とランプの暖色、自然な肌と布の質感を改善。
- 手紙、紙、文字、涙、余分な手足、恐怖表現がないことを、静止画と完成動画の
  24.8秒・27.7秒・30.5秒で目視確認した。
