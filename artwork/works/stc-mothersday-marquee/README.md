...
`stc-marquee-v16.html` のタイポグラフィと梯子を運ぶテニスボールの動きを継承し、
...
- Loudness: -13.3 LUFS integrated / -1.5 dBTP
- Visual checks: 0.5 / 5.3 / 8.8 / 12.3 seconds checked at full resolution
